...
Tests are a design requirement for this template and every descendant project.
...
- For CLI templates, use Cargo's `CARGO_BIN_EXE_<name>` integration-test environment instead of shelling through a hard-coded `target/` path.
